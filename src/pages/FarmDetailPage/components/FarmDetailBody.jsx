...
export default function FarmBody(props) {
  let dataResuld = carouselItems;
  React.useEffect(() => {
    if (dataResuld == null) {
      let farmId = props.match.params.id;
      console.log(farmId);
      //   dataResuld = carouselItems;
    }
  });
        ...
        <Container>
          ...
          <Row>
            ...
            <Col md="5" sm="6" style={{ color: '#000000' }}>
              ...
              <hr />
              <p>
                Với mục tiêu mang thực phẩm sạch quay lại bữa ăn của người Việt, chúng tôi cam kết tự trồng tất cả các sản phẩm rau hữu cơ với 4 tiêu
                chí: - Không thuốc bảo vệ thực vật - Không phân bón hóa học - Không thuốc kích thích tăng trưởng - Không chất bảo quản sau thu hoạch
              </p>
              <hr />
